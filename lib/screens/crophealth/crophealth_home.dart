...
class _CropHealthHomeState extends State<CropHealthHome> {
  void getvarshere() async {
    ...
    List<String> temp = prefs.getStringList("spSelectedcrops") ??
        CropHealthselection.selectedcrops;
    ...
    CropHealthselection.cropsbool =
        decodedMap.map((key, value) => MapEntry(key, value));
                  ...
                  GestureDetector(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('Banana'.tr, style: TextStyle(color: Colors.black))
                      ],
                    ),
                  ),
                ]),
            ...
            Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      setState(() {
                        if (CropHealthselection.cropsbool['Sugarcane'] ==
                            false) {
                  ...
                  GestureDetector(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('Tomato'.tr, style: TextStyle(color: Colors.black))
                      ],
                    ),
                  ),
                ]),
...
// wrap this in a gesture detector and on tap of this button navigate to the next page
                  ...
                  GestureDetector(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('Wheat'.tr, style: TextStyle(color: Colors.black))
                      ],
                    ),
                  ),
                  GestureDetector(
                    ...
                    child: Column(
                      children: [
                        ...
                        Text('Potato'.tr, style: TextStyle(color: Colors.black))
                      ],
                    ),
                  ),
                ]),
            ...
            TextButton(
              onPressed: () async {
                ...
                print(CropHealthselection.selectedcrops);
                prefs.setStringList(
                    'spSelectedcrops', CropHealthselection.selectedcrops);
                ...
                showDialog(
                    context: context,
                    builder: (context) {
                      // if the selected crops are less than 0, then show a dialog box which will show to select atleast one crop
                      if (CropHealthselection.selectedcrops.length < 1) {
                        return AlertDialog(
                          title: Text(
                            'Warning'.tr,
                          ...
                          content: Container(
                              ...
                              // height: 100 ,
                              child: Text(
                                'Please select atleast one crop'.tr,
                                style: TextStyle(
                        ...
                        return AlertDialog(
                          ...
                          content: // show all these crops with comma separated
                            ...
                            CropHealthselection.cropsbool.keys
                                .where((k) =>
                                    CropHealthselection.cropsbool[k] == true)
                                .toList()
                                .join(', ')
